        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8 animate-fade-in">
            <div className="inline-block">
              <span className="text-teal-400 text-sm font-semibold tracking-widest uppercase px-4 py-2 bg-teal-500/10 rounded-full border border-teal-500/30">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 animate-fade-in leading-tight">
            Pure Hydration,
            <span className="block text-teal-400 mt-2">Refined Elegance</span>
          </h1>
      ...
      <section className="py-20 bg-navy-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="group p-8 rounded-lg border border-teal-500/20 hover:border-teal-500/50 bg-gradient-to-br from-navy-700/50 to-navy-800/50 backdrop-blur-sm hover:bg-navy-700/80 transition-all duration-300 transform hover:scale-105">
              <div className="w-14 h-14 rounded-full bg-teal-500/20 flex items-center justify-center mb-6 group-hover:bg-teal-500/40 transition-colors">
                <Droplet className="w-7 h-7 text-teal-400" />
              </div>
              <h4 className="text-xl font-bold text-white mb-3">Pure Source</h4>
              <p className="text-white/70 leading-relaxed">
                Sourced from pristine natural springs and Himalayan regions,
                ensuring the highest purity standards with rigorous testing.
              </p>
            </div>
      ...
      <section id="about" className="py-20 bg-gradient-to-b from-navy-800 to-navy-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            {/* Image Placeholder */}
            <div className="relative h-96 rounded-lg overflow-hidden border border-teal-500/30 bg-gradient-to-br from-navy-700 to-navy-800">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <Droplet className="w-24 h-24 text-teal-500/30 mx-auto mb-4" />
                  <p className="text-white/50 font-light">Premium Water</p>
                </div>
              </div>
            </div>
          </div>
